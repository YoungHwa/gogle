				...
				<div class="block">
						...
						<tbody>
							<c:forEach var="member" items="${list}">
								<tr class="odd gradeX" style='cursor: pointer;'
									onclick="document.location.href='${rootPath}/member/view.do?email=${member.email}';">
									<td>${member.name}</td>
									<td>${member.email}</td>
									<td>${member.tel}</td>
									<td><c:choose>
					...
					<div class="table_bottom_btns_div">
						<button class="btn-icon btn-blue btn-person"
							onclick="document.location.href='${rootPath}/member/add.do';">
							<span></span>회원 등록
						</button>
					</div>
