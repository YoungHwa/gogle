...
<head>
<meta charset="UTF-8" />
<title>Gogle - Change Password</title>
					...
					<form action="passwordChange.do" method="post">
						<table class="form">
							<tr>
								...
								<td><input type="text" class="mini" name="email"
									value="${param.email}" readonly="readonly"></td>
							</tr>
							<tr>
								<td><label> 이전 비밀번호</label></td>
								<td><input type="password" class="mini" name="password">
								</td>
							</tr>
							<tr>
								<td><label> 새 비밀번호</label></td>
								<td><input type="password" class="mini" name="newPassword">
								</td>
							</tr>
							<tr>
								<td><label> 새 비밀번호(확인)</label></td>
								<td><input type="password" class="mini" name="newPassword2">
								</td>
							</tr>
						</table>
						<div class="form_submit_div">
							...
							<input type="button" value="취소" class="btn btn-grey reset"
								onclick="document.location.href='myInfoUpdateForm.do?email=${param.email}'">
						</div>
					</form>
				</div>
			</div>
