					...
					<table class="form">
						<tr>
							...
							<td>사진<c:choose>
									...
									<c:otherwise>
										<img src="${rootPath}/img/img-profile.jpg" alt="Profile Pic"
						...
						<tr>
							...
							<td><c:choose>
									<c:when test="${memberInfo.level == 0}">일반멤버</c:when>
						...
						<tr>
							...
							<td><input type="text" class="mini"
								value="${memberInfo.name}" disabled /></td>
						</tr>
						<tr>
							<td><label> 이메일</label></td>
							<td><input type="text" class="mini"
								value="${memberInfo.email}" disabled /></td>
						</tr>
						<tr>
							<td><label> 전화</label></td>
							<td><input type="text" class="mini"
								value="${memberInfo.tel}" disabled /></td>
						</tr>
						<tr>
							<td><label> 블로그</label></td>
							<td><input type="text" class="mini"
								value="${memberInfo.blog}" disabled /></td>
						</tr>
						<tr>
							<td><label> 우편번호</label></td>
							<td><input type="text" class="mini" value="" disabled /></td>
						</tr>
						
						<tr>
							<td><label> 상세주소</label></td>
							<td><input type="text" class="mini" value="${memberInfo.detailAddress}" disabled /></td>
						</tr>
						<tr>
							<td><label> 등록일</label></td>
							<td><input type="text" class="mini" value="${memberInfo.regDate}" disabled /></td>
						</tr>
						<tr>
							<td><label> 태그</label></td>
							<td><input type="text" class="mini"
								value="${memberInfo.tag}" disabled /></td>
						</tr>
					</table>
			...
			<div class="box round">
				...
				<div class="block">
					<table class="data display datatable" id="example">
						...
						<tbody>
							<c:forEach var="memberProject" items="${myprojects}">
								<tr class="odd gradeX" align="center">
									<td>${memberProject.title}</td>
									<td>${memberProject.no}</td>
									<td><c:if test="${memberProject.level == 0}">★</c:if></td>
									<td></td>
									<td></td>
								</tr>
							</c:forEach>
