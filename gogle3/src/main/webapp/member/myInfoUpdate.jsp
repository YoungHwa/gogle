...
<head>
<meta charset="UTF-8" />
<title>Gogle - My Info Update</title>
					...
					<form action="myInfoUpdate.do" method="post"
						...
						<table class="form">
							<tr>
								...
								<td><input type="text" class="mini" name="email"
							...
							<tr>
								...
								<td><input type="password" class="mini" name="password">
									<input type="button" value="비밀번호 변경"
									onclick="document.location.href='${rootPath}/member/passwordChange.do?email=${member.email}'"
									class="btn btn-small btn-grey"></td>
							</tr>
							<tr>
								<td><label> 이름</label></td>
								<td><input type="text" class="mini" name="name"
									value="${member.name}"></td>
							</tr>
							<tr>
								<td><label> 전화</label></td>
								<td><input type="text" class="mini" name="tel"
									value="${member.tel}"></td>
							</tr>
							<tr>
								<td><label>기존사진</label></td>
								<td><img src="${rootPath}/file/${memberInfo.photos[0]}"
									alt="Profile Pic" class="content_member_photo_img"></td>
							</tr>
							<tr>
								<td><label>사진변경</label></td>
								<td><input type="file" class="mini" name="photo"></td>
							</tr>
							<tr>
								<td><label> 블로그</label></td>
								<td><input type="text" class="mini" name="blog"
									value="${member.blog}"></td>
							</tr>
							<tr>
								<td><label> 우편변호</label></td>
								<td><input type="text" class="mini" name="postno" value="">
									<input type="button" value="우편번호 찾기"
									class="btn btn-small btn-grey"></td>
							</tr>
							<tr>
								<td><label> 기본주소</label></td>
								<td><input type="text" class="mini" name="basicAddr"
									value=""></td>
							</tr>
							<tr>
								<td><label> 상세주소</label></td>
								<td><input type="text" class="mini" name="detailAddr"
									value=""></td>
							</tr>
							<tr>
								<td><label> 태그</label></td>
								<td><input type="text" name="tag" class="mini"
									value="${member.tag}"></td>
							</tr>
							<tr>
								<td><label> 권한</label></td>
								<td><select id="select" name="level">
										<c:choose>
