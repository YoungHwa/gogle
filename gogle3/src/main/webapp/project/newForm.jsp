					...
					<form action="add.do" method="post">
						<table class="form">
							<tbody>
								...
								<tr>
									...
									<td><textarea rows="4" cols="50" class="mini"
											name="content"></textarea><br></td>
								</tr>
								<tr>
									<td><label>시작일</label></td>
									<td><input type="text" class="mini"
										placeholder="예)2013-4-5" name="startDate" /> <br></td>
								</tr>
								<tr>
									<td><label>종료일</label></td>
									<td><input type="text" class="mini"
										placeholder="예)2013-4-5" name="endDate" /> <br></td>
								</tr>
								<tr>
						...
						<div class="form_submit_div">
							<input type="reset" value="목록"
								...
								class="btn btn-yello reset"> <input type="submit"
								value="등록" class="btn btn-blue submit"> <input
								type="reset" value="취소" class="btn btn-grey reset">
