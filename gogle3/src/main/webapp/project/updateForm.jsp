                ...
                <div class="block ">
                    ...
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td> <input type="date" class="mini" value="${project.startDate}" name="startDate"/>
                            <br></td>
                        </tr>
                        <tr>
                            <td><label>종료일</label></td>
                            <td> <input type="date" class="mini" value="${project.endDate}" name="endDate"/>
                            <br></td>
                        </tr>
                         <tr>
...
<%-- 						onclick="document.location.href='${rootPath}/project/list.do';" class="btn btn-orange reset"/> --%>
						...
						onclick="document.location.href='${rootPath}/project/list.do';" class="btn btn-blue reset"/>
