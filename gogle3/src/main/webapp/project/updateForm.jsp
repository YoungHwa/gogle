...
<title>Gogle - Project Update</title>
				...
				<div class="block ">
					<form action="update.do" method="post">
						<table class="form">
							<tbody>
								<tr>
									...
									<td class="col2"><input type="text" value="${project.no}"
										readonly="readonly" name="no" /><br></td>
								</tr>
								<tr>
									<td class="col1"><label>프로젝트 명 </label></td>
									<td class="col2"><input type="text" class="mini"
										value="${project.title}" name="title" /><br></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" class="mini"
										value="${project.startDate}" placeholder="예)2013-4-5"
										name="startDate" /> <br></td>
								</tr>
								<tr>
									<td><label>종료일</label></td>
									<td><input type="text" class="mini"
										value="${project.endDate}" placeholder="예)2013-4-5"
										name="endDate" /> <br></td>
								</tr>
								<tr>
									<td><label>태그</label></td>
									<td><input type="text" class="mini" value="${project.tag}"
										placeholder="예)태그1 태그2 태그3 (공백으로 구분)" name="tag" /> <br></td>
								</tr>
						...
						<div class="form_submit_div">
							...
							<%-- 						onclick="document.location.href='${rootPath}/project/list.do';" class="btn btn-orange reset"/> --%>



							<input type="submit" value="등록"
								onclick="document.location.href='${rootPath}/project/list.do';"
								class="btn btn-blue reset" /> <input type="reset" value="취소"
