...
public class MemberDao {
	...
	public void addPhoto(String email, String filename) throws Exception {
		SqlSession sqlSession = sqlSessionFactory.openSession();
		try {
			HashMap<String,Object> paramMap = new HashMap<String,Object>();
			paramMap.put("email", email);
	...
	public void deleteProjectMember(String email) throws Exception {
		SqlSession sqlSession = sqlSessionFactory.openSession();
		try {
			sqlSession.insert(
				"net.bitacademy.java41.dao.MemberMapper.deleteProjectMember", email);
			sqlSession.commit();
