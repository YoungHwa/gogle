...
public class ProjectDao {
	...
	public String leaderByProject(int no) throws Exception {
		SqlSession sqlSession = sqlSessionFactory.openSession();
		
		try {
			return sqlSession.selectOne(
					"net.bitacademy.java41.dao.ProjectMapper.leaderByProject",no);
		} catch (Exception e) {
			throw e;
	...
	public List<Member> memberByProject(int no) throws Exception {
		...
		try {
			return sqlSession.selectList(
					"net.bitacademy.java41.dao.ProjectMapper.memberByProject",
					no);
		} catch (Exception e) {
			throw e;
