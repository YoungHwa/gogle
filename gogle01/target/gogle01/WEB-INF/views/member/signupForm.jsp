...
<link href="${rootPath}/css/fancy-button/fancy-button.css"
	rel="stylesheet" type="text/css" />
<!--Jquery UI CSS-->
<link href="${rootPath}/css/themes/base/jquery.ui.all.css"
	rel="stylesheet" type="text/css" />
<!-- BEGIN: load jquery -->
...
<script src="${rootPath}/js/jquery-ui/jquery.ui.widget.min.js"
	type="text/javascript"></script>
<script src="${rootPath}/js/jquery-ui/jquery.ui.datepicker.min.js"
	type="text/javascript"></script>
<script src="${rootPath}/js/jquery-ui/jquery.ui.progressbar.min.js"
	type="text/javascript"></script>
<!-- jQuery dialog related-->
<script src="${rootPath}/js/jquery-ui/external/jquery.bgiframe-2.1.2.js"
	type="text/javascript"></script>
<script src="${rootPath}/js/jquery-ui/jquery.ui.mouse.min.js"
	type="text/javascript"></script>
<script src="${rootPath}/js/jquery-ui/jquery.ui.draggable.min.js"
	type="text/javascript"></script>
<script src="${rootPath}/js/jquery-ui/jquery.ui.position.min.js"
	type="text/javascript"></script>
<script src="${rootPath}/js/jquery-ui/jquery.ui.resizable.min.js"
	type="text/javascript"></script>
<script src="${rootPath}/js/jquery-ui/jquery.ui.dialog.min.js"
	type="text/javascript"></script>
<script src="${rootPath}/js/jquery-ui/jquery.effects.core.min.js"
	type="text/javascript"></script>
<script src="${rootPath}/js/jquery-ui/jquery.effects.blind.min.js"
	type="text/javascript"></script>
<script src="${rootPath}/js/jquery-ui/jquery.effects.explode.min.js"
	type="text/javascript"></script>
<!-- jQuery dialog end here-->
<script src="${rootPath}/js/jquery-ui/jquery.ui.accordion.min.js"
	type="text/javascript"></script>
<!--Fancy Button-->
<script src="${rootPath}/js/fancy-button/fancy-button.js"
	type="text/javascript"></script>
<script src="${rootPath}/js/setup.js" type="text/javascript"></script>
<!-- Load TinyMCE -->
<script src="${rootPath}/js/tiny-mce/jquery.tinymce.js"
	type="text/javascript"></script>
<script type="text/javascript">
						...
						<div class="aui-header-inner">
							<div class="aui-header-primary">
								<h1 class="aui-header-logo aui-header-logo-bitbucket logged-out">
									<a href="${rootPath}/auth/loginForm.do"
										class="aui-nav-imagelink" id="logo-link"> <span
										class="aui-header-logo-device">Gogle</span>
									</a>
								</h1>
							...
							<div class="aui-header-secondary">
								<ul role="menu" class="aui-nav">
									<li id="user-options"><a
										href="${rootPath}/auth/loginForm.do"
										class="aui-nav-link login-link">Log in</a></li>
								</ul>
						...
						<section class="form-container">
							...
							<form id="registration-form" method="post" action="signup.do"
								...
								<div id="id_email_group" class="field-group ">
									...
									</label> <input id="email" type="email" class="required text"
										name="email" maxlength="75" placeholder="hong@test.com" />
								</div>
								<div id="id_username_group" class="field-group ">
									<label for="id_username"> Username<span
										class="aui-icon icon-required"></span><span class="content">required</span>
									</label> <input id="name" type="text" class="required text" name="name"
										maxlength="30" placeholder="홍길동" />
									<div class="description">e.g. jdoe</div>
								</div>
								<div id="id_password1_group" class="field-group ">
									<label for="id_password1"> Password<span
										class="aui-icon icon-required"></span><span class="content">required</span>
									</label> <input id="password" type="password" class="required text"
										name="password" placeholder="password" />
								</div>
								<div id="id_password2_group" class="field-group ">
									<label for="id_password2"> Password (again)<span
										class="aui-icon icon-required"></span><span class="content">required</span>
									</label> <input id="password2" type="password" class="required text"
										name="password2" placeholder="password (again)" />
								</div>
								<div id="id_phone_group" class="field-group ">
									<label for="id_phone"> Phone<span
										class="aui-icon icon-required"></span><span class="content">required</span>
									</label> <input id="tel" type="phone" class="required text" name="tel"
										placeholder="010-0000-0000" />
								</div>
								<div id="id_photo_group" class="field-group ">
									<label for="id_photo"> photo<span
										class="aui-icon icon-required"></span><span class="content">required</span>
									</label> <input id="photo" type="file" class="required text"
										name="photo" />
								</div>
								...
								<div class="buttons-container">
									<div class="buttons">
										<button class="btn btn-blue" type="button" onclick="signUp()">Sign
											up</button>
										<input type="reset" value="cancle"
											onclick="document.location.href='${rootPath}/auth/loginForm.do';"
											class="btn btn-grey reset">
							...
							<div
								style="color: red; width: 300px; height: 200px; float: left; margin-left: 10px;">
								<video autoplay="autoplay" loop="loop"
									style="width: 300px; height: 200px; vertical-align: top;">
									<source src="${rootPath}/res/snlkorea.mp4">
								</video>
							</div>
