	...
	<div class="container_12">
		...
		<div class="grid_10">
			<div class="box round first grid">
				<h2>${param.projectNo}번 프로젝트 피드목록</h2>
				<br>
				<div id="submenu">
						<input type="submit" value="기본정보" class="btn btn-yellow btn-small"
							onclick="document.location.href='${rootPath}/project/view.do?no=${param.projectNo}'">
						<input type="submit" value="작업들" class="btn btn-yellow btn-small"
							onclick="document.location.href='${rootPath}/task/list.do?projectNo=${param.projectNo}'">
						<input type="submit" value="피드" class="btn btn-yellow btn-small"
								onclick="document.location.href='${rootPath}/feed/main.do?projectNo=${param.projectNo}'">
					</div>
