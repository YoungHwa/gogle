					...
					<div>
						<div id="submenu">
							...
							<input type="submit" value="피드" class="btn btn-yellow btn-small"
								onclick="document.location.href='${rootPath}/feed/main.do?projectNo=${project.no}'">
						</div>
						...
						<table class="form">
							...
							<tr>
								...
								<td><input type="text" class="mini" name="projectNo" value="${project.no}"
									disabled /></td>
							</tr>
							<tr>
							...
							<tr align="justify">
								...
								<td><textarea rows="5" cols="25" class="mini"
										readonly="readonly">
								${project.content}
								</textarea></td>
