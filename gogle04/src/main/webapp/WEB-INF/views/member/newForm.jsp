					...
					<form action="add.do" method="post" enctype="multipart/form-data">
						<table class="form">
							<tr>
								...
								<td><input type="text" class="mini" name="email" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="password" class="mini" name="password2" />
								</td>
							</tr>
							<tr>
								<td><label> *이름</label></td>
								<td><input type="text" class="mini" name="name" /></td>
							</tr>
							<tr>
								<td><label> *전화</label></td>
								<td><input type="text" class="mini" name="tel" /></td>
							</tr>
							<tr>
								<td><label> 블로그</label></td>
								<td><input type="text" class="mini" name="blog" /></td>
							</tr>
							<tr>
								<td><label> 우편변호</label></td>
								<td><input type="text" class="mini" name="postno" /> <input
									type="button" value="우편번호찾기"></td>
							</tr>
							<tr>
								<td><label> 기본주소</label></td>
								<td><input type="text" class="mini" name="basicAddr" /></td>
							</tr>
							<tr>
								<td><label> 상세주소</label></td>
								<td><input type="text" class="mini" name="detailAddr" /></td>
							</tr>
							<tr>
									<td class="col1"><label>사진등록 </label></td>
									<td class="col2"><input type="file" class="mini"
										name="photo"><br></td>
							</tr>
							<tr>
								<td><label> 태그</label></td>
								<td><input type="text" class="mini" name="tag" /></td>
							</tr>
							<tr>
