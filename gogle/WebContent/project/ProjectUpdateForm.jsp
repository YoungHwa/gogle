            ...
            <div class="box round first grid">
                ...
                <div class="block ">
                    ...
                    <input type="reset" value="목록" 
						...
						<input type="submit" value="등록" class="btn <input type="reset" value="목록" 
						onclick="document.location.href='${rootPath}/project/list.do';" class="btn btn-yello reset"> submit">
