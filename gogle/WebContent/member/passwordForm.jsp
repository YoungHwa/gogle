                ...
                <div class="block ">
                    ...
                    <table class="form">
                        <tr>
                            ...
                            <td>
                                <input type="text" class="mini" name="email" value="${param.email}" readonly="readonly">
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="password" class="mini" name="newPassword">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="password" class="mini" name="newPassword2">
                            </td>
                        </tr>
                    </table>
                    <div class="form_submit_div">
						...
						<input type="button" value="취소" class="btn btn-grey reset"
								onclick="document.location.href='myInfoUpdateForm.do'">
					</div>
                    </form>
                </div>
            </div>
