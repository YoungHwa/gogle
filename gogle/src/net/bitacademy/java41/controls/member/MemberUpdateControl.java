...
public class MemberUpdateControl implements PageControl {
	...
	public String execute(Map<String, Object> model) throws Exception {
		...
		String oldpwd = memberInfo.getPassword();
		
		memberInfo.setPassword(!"".equals(password) ? password : null);
		...
		System.out.println("info" + memberInfo.getPassword());
		System.out.println("old" + oldpwd);
		
		if (memberInfo.getPassword().equals(oldpwd)){
